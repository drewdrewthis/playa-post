 ...
 *
 * **One procedure, and the delivery half of this module has none on purpose.**
 ...
 * client a lever on other people's notification timing.
 *
 * Nested under `push` so the path spells what it acts on, the same convention
 * `connections.trust.set` follows. Notification *preferences* are M5 and arrive as a
 * sibling.
 */
