...
const inputParity: InputParity = {
  ...
  'connections.personalLink.ensure': true,
  'connections.personalLink.rotate': true,
  'connections.personalLink.open': true,
  'connections.requests.send': true,
  'connections.requests.listInbox': true,
  'connections.requests.decide': true,
  'graph.list': true,
